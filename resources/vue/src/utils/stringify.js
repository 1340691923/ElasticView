  ...
  var t = n(function (e) {
    ...
    n = s, t = function () {
      ...
      return e.highestId = 0, e.prototype.toString = function (e) {
        ...
        var o = this.table[t];
        var r = o.states.filter(function (e) {
        ...
        var n = e.wantedBy[0];
        var t = [e].concat(s);
        var o = this.buildFirstStateStack(n, t)
      ...
      var n = {
        ...
        ParserRules: [{name: '_$ebnf$1', symbols: []}, {
          ...
          name: 'numeric_type', symbols: ['numeric_type$subexpression$1', 'numeric_type$ebnf$1'], postprocess: e => {
            ...
            s === 'NUMERIC' && (s = 'DECIMAL')
            let n = {DECIMAL: 10, FLOAT: 23, DOUBLE: 53}[s];
            let t = 0
