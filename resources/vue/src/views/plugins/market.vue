  ...
  <div class="app-container">
    <div class="search-container">
      <el-form :inline="true">
        ...
        <el-form-item label="插件名/插件描述:">
          <el-input clearable v-model="input.search_txt" ></el-input>
        </el-form-item>
        <el-form-item label="排序:">
          <el-select style="width:200px" v-model="input.order_by_col">
            <el-option
              label="star次数"
              value="star_cnt"
            />
                        ...
                        <template #header>
                          <div class="card-header">
                            ...
                            <div style="float:right">
                              ...
                              <el-tag type="warning">最大支持ev版本:{{item.gte_ev_dependency_ver}}</el-tag>
                              &nbsp;
                              <el-tag type="success">最小支持ev版本:{{item.lte_ev_dependency_ver}}</el-tag>
                              &nbsp;
...
import {PluginMarket, GetPluginInfo,InstallPlugin,StarPlugin,UnInstallPlugin} from "@/api/plugins";
