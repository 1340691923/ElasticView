...
export const asyncRoutes = [
  ...
  {
    path: '/log-search-home',
    component: 'layout',
    redirect: '/log-search-home/log-search-home',
    alwaysShow: false,
    meta: {
      title: '日志查询',
      icon: 'el-icon-copy-document'
    ...
    children: [
      {
        path: 'log-search-home',
        component: 'views/log-search-home/log-search-home',
        name: 'log-search-home',
        meta: {
          title: '日志查询(国内)',
          icon: 'el-icon-shopping-bag-2'
        }
  ...
  {
    path: '/log-search-foreign',
    component: 'layout',
    redirect: '/log-search-foreign/log-search-foreign',
    alwaysShow: false,
    meta: {
      title: '日志查询(国外)',
      icon: 'el-icon-copy-document'
    ...
    children: [
      {
        path: 'log-search-foreign',
        component: 'views/log-search-foreign/log-search-foreign',
        name: 'log-search-foreign',
        meta: {
          title: '日志查询(国外)',
          icon: 'el-icon-shopping-bag-2'
        }
  ...
  },
  {
    path: '/log-config',
    component: 'layout',
    redirect: '/log-config/log-config',
    alwaysShow: false,
    meta: {
      title: '日志配置',
      icon: 'el-icon-copy-document'
    ...
    children: [
      {
        path: 'log-config',
        component: 'views/log-config/log-config',
        name: 'log-config',
        meta: {
          title: '日志配置',
          icon: 'el-icon-shopping-bag-2'
...
export const RoutesComponentmaps = {
  ...
  'views/log-search-home/log-search-home': () => import('@/views/log-search-home/log-search-home'),
  'views/log-search-foreign/log-search-foreign': () => import('@/views/log-search-foreign/log-search-foreign'),
  'views/log-config/log-config': () => import('@/views/log-config/log-config'),
}
