  ...
  <div class="app-container">
    <el-card class="box-card">
      <div class="filter-container">
        ...
        <el-input style="width: 300px" class="filter-item" v-model="input.remark" clearable placeholder="备注名"></el-input>
      ...
      <el-dialog :close-on-click-modal="false" @close="closeDialog" :visible.sync="open" title="新增数据源">
        <el-card class="box-card">
          ...
          <div style="text-align:right;">
            ...
            <el-button :disabled="formLinkLoading" v-loading="formLinkLoading" type="success" icon="el-icon-link" @click="link({typ:form.typ,db_name:form.db_name,ip:form.ip,
...
import {LinkInfoList,InsertLink,DelLinkById,TestLink} from '@/api/datax'
