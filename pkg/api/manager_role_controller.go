...
func NewManagerRoleController(baseController *BaseController, log *logger.AppLogger, cfg *config.Config, jwtSvr *jwt_svr.Jwt, gmRoleService *gm_role.GmRoleService, gmUserService *gm_user.GmUserService, rbac *access_control.Rbac, orm *orm.Gorm, esLinkService *es_link_service.EsLinkService) *ManagerRoleController {
...
func (this *ManagerRoleController) RolesAction(ctx *gin.Context) {
	...
	roles, count, err := this.gmRoleService.Select(ctx,
