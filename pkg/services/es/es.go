...
func NewEsClientService(cfg *config.Config, esCache *cache_service.EsCache, esLinkV2Dao *dao.EsLinkV2Dao, gmUserDao *dao.GmUserDao, orm *sqlstore.SqlStore) *EsClientService {
