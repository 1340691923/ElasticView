...
func NewEsClient8(cfg *proto2.Config) (pkg.ClientInterface, error) {

	ds, ok := cache.GetDataSourceCache(cfg.ConnectId)

	if !ok {
		obj := &EsClient8{}
		esCfg, err := cfg.ConvertV8(
			es_log.NewLogger(cfg.Cfg.EnableLogEs, true, cfg.Cfg.EnableLogEsRes, logger2.EsReqLog.Named("elasticsearch8.x")),
			nil, nil)
		if err != nil {
...
func (this *EsClient8) init(config elasticV8.Config) (err error) {
	this.client, err = elasticV8.NewClient(config)
	if err != nil {
...
func (this *EsClient8) EsVersion() (version int, err error) {
	return 8, nil
}

func (this *EsClient8) Ping(
	ctx context.Context,
) (
	res *proto.Response,
	err error,
...
func (this *EsClient8) EsGetMapping(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsSnapshotCreate(
	ctx context.Context,
	repository string,
	snapshot string,
...
func (this *EsClient8) EsPerformRequest(
	ctx context.Context,
	req *http.Request,
) (
	res *proto.Response, err error) {
...
func (this *EsClient8) EsSnapshotDelete(
	ctx context.Context,
	repository string,
	snapshot string,
) (
...
func (this *EsClient8) EsRestoreSnapshot(
	ctx context.Context,
	repository string,
	snapshot string,
	waitForCompletion *bool,
...
func (this *EsClient8) EsIndicesClearCache(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsIndicesClose(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsIndicesForcemerge(
	ctx context.Context,
	indexNames []string,
	maxNumSegments *int,
) (
...
func (this *EsClient8) EsDeleteByQuery(
	ctx context.Context,
	indexNames []string,
	documents []string,
	body interface{},
	...
	req := esapi.DeleteByQueryRequest{Index: indexNames, Body: esutil.NewJSONReader(body)}
	httpRes, err := req.Do(ctx, this.client)
	if err != nil {
		return nil, errors.WithStack(err)
	}
...
func (this *EsClient8) EsSnapshotStatus(
	ctx context.Context,
	repository string,
	snapshot []string,
...
func (this *EsClient8) EsSnapshotGetRepository(
	ctx context.Context,
	repository []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsSnapshotCreateRepository(
	ctx context.Context,
	repository string,
	reqJson proto.Json,
) (
...
func (this *EsClient8) EsSnapshotDeleteRepository(
	ctx context.Context,
	repository []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsGetIndices(
	ctx context.Context,
...
func (this *EsClient8) EsCatHealth(
	ctx context.Context,
...
func (this *EsClient8) EsCatShards(
	ctx context.Context,
...
func (this *EsClient8) EsCatCount(
	ctx context.Context,
...
func (this *EsClient8) EsCatAllocationRequest(
	ctx context.Context,
...
func (this *EsClient8) EsCatAliases(
	ctx context.Context,
...
func (this *EsClient8) EsIndicesSegmentsRequest(
	ctx context.Context,
	human bool,
) (
	res *proto.Response,
...
func (this *EsClient8) EsClusterStats(
	ctx context.Context,
	human bool,
) (
	res *proto.Response,
...
func (this *EsClient8) EsCatNodes(
	ctx context.Context,
	h []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsIndicesPutSettingsRequest(
	ctx context.Context,
...
func (this *EsClient8) EsCreateIndex(
	ctx context.Context,
...
func (this *EsClient8) EsDeleteIndex(
	ctx context.Context,
...
func (this *EsClient8) EsIndicesGetSettingsRequest(
	ctx context.Context,
...
func (this *EsClient8) EsPutMapping(
	ctx context.Context,
...
func (this *EsClient8) EsGetAliases(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient8) EsAddAliases(
	ctx context.Context,
	indexName []string,
	aliasName string,
) (
...
func (this *EsClient8) EsRemoveAliases(
	ctx context.Context,
	indexName []string,
	aliasName []string,
) (
...
func (this *EsClient8) EsMoveToAnotherIndexAliases(
	ctx context.Context,
...
func (this *EsClient8) EsTaskList(
	ctx context.Context,
) (
	res *proto.Response,
	err error,
...
func (this *EsClient8) EsTasksCancel(
	ctx context.Context,
	taskId string,
) (
	res *proto.Response,
