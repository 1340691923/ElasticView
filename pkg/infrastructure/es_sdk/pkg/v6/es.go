...
func NewEsClient6(cfg *proto2.Config) (pkg.ClientInterface, error) {
	ds, ok := cache.GetDataSourceCache(cfg.ConnectId)

	if !ok {
		obj := &EsClient6{}
		esCfg, err := cfg.ConvertV6(
			es_log.NewLogger(cfg.Cfg.EnableLogEs, true, cfg.Cfg.EnableLogEsRes, logger2.EsReqLog.Named("elasticsearch6.x")),
			nil, nil)
		if err != nil {
...
func (this *EsClient6) EsVersion() (version int, err error) {
	return 6, nil
}
...
func (this *EsClient6) EsGetMapping(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsSnapshotCreate(
	ctx context.Context,
	repository string,
	snapshot string,
...
func (this *EsClient6) EsPerformRequest(
	ctx context.Context,
	req *http.Request,
) (
	res *proto.Response, err error) {
...
func (this *EsClient6) EsSnapshotDelete(
	ctx context.Context,
	repository string,
	snapshot string,
) (
...
func (this *EsClient6) EsRestoreSnapshot(
	ctx context.Context,
	repository string,
	snapshot string,
	waitForCompletion *bool,
...
func (this *EsClient6) EsSnapshotStatus(
	ctx context.Context,
	repository string,
	snapshot []string,
...
func (this *EsClient6) EsSnapshotGetRepository(
	ctx context.Context,
	repository []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsSnapshotCreateRepository(
	ctx context.Context,
	repository string,
	reqJson proto.Json,
) (
...
func (this *EsClient6) EsSnapshotDeleteRepository(
	ctx context.Context,
	repository []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsGetIndices(
	ctx context.Context,
...
func (this *EsClient6) EsCatHealth(
	ctx context.Context,
...
func (this *EsClient6) EsCatShards(
	ctx context.Context,
...
func (this *EsClient6) EsCatCount(
	ctx context.Context,
...
func (this *EsClient6) EsCatAllocationRequest(
	ctx context.Context,
...
func (this *EsClient6) EsCatAliases(
	ctx context.Context,
...
func (this *EsClient6) EsIndicesSegmentsRequest(
	ctx context.Context,
	human bool,
) (
	res *proto.Response,
...
func (this *EsClient6) EsClusterStats(
	ctx context.Context,
	human bool,
) (
	res *proto.Response,
...
func (this *EsClient6) EsCatNodes(
	ctx context.Context,
	h []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsIndicesClearCache(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsIndicesClose(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsIndicesForcemerge(
	ctx context.Context,
	indexNames []string,
	maxNumSegments *int,
) (
...
func (this *EsClient6) EsDeleteByQuery(
	ctx context.Context,
	indexNames []string,
	documents []string,
	body interface{},
...
func (this *EsClient6) EsIndicesPutSettingsRequest(
	ctx context.Context,
...
func (this *EsClient6) EsCreateIndex(
	ctx context.Context,
...
func (this *EsClient6) EsDeleteIndex(
	ctx context.Context,
...
func (this *EsClient6) EsIndicesGetSettingsRequest(
	ctx context.Context,
...
func (this *EsClient6) EsPutMapping(
	ctx context.Context,
...
func (this *EsClient6) EsGetAliases(
	ctx context.Context,
	indexNames []string,
) (
	res *proto.Response,
...
func (this *EsClient6) EsAddAliases(
	ctx context.Context,
	indexName []string,
	aliasName string,
) (
...
func (this *EsClient6) EsRemoveAliases(
	ctx context.Context,
	indexName []string,
	aliasName []string,
) (
...
func (this *EsClient6) EsMoveToAnotherIndexAliases(
	ctx context.Context,
...
func (this *EsClient6) EsTaskList(
	ctx context.Context,
) (
	res *proto.Response,
	err error,
...
func (this *EsClient6) EsTasksCancel(
	ctx context.Context,
	taskId string,
) (
	res *proto.Response,
