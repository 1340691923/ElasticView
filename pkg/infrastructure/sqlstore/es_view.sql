...
CREATE TABLE `gm_operater_log` (
                                   `id`         INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                                   `operater_id` INTEGER      NOT NULL DEFAULT '0',
                                   `operater_name` TEXT               NOT NULL   DEFAULT '',
                                   `operater_action`     TEXT         NOT NULL DEFAULT '',
                                   `method`     TEXT         NOT NULL DEFAULT '',
                                   `body`     BLOB         NOT NULL ,
                                   `operater_role_id` INTEGER      NOT NULL DEFAULT '0',
                                   `created`    timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP
);
