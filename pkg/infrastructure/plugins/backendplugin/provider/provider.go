...
func DefaultProvider(_ context.Context, log hclog.Logger, logPath string, closeLogWriteCallback func() error, provideCfg *Config, cfg *config.Config) *plugin.Plugin {
	p := new(plugin.Plugin)
